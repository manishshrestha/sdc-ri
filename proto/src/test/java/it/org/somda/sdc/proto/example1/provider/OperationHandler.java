...
import org.somda.sdc.proto.provider.sco.IncomingSetServiceRequest;
import org.somda.sdc.proto.provider.sco.InvocationResponse;
...
public class OperationHandler implements OperationInvocationReceiver {
    ...
    InvocationResponse genericSetValue(Context context, BigDecimal data) {
        ...
        com.example.provider1.ProviderUtil.addMetricQualityDemo(targetState.getMetricValue());
