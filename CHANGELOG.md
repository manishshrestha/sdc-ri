...
- `org.somda.sdc.dpws.http.apache.CommunicationLogOuterHttpRequestInterceptor` adds local certificates to TransportInfo and `org.somda.sdc.dpws.http.apache.CommunicationLogInnerHttpResponseInterceptor` adds peer certificates to TransportInfo. (#204)
