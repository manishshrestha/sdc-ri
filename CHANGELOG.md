...
- `org.somda.sdc.biceps.guice.DefaultBicepsConfigModule` can be configured to specify which DescriptionPreprocessingSegments and StatePreprocessingSegments should be used for consumer or provider. (#196)
