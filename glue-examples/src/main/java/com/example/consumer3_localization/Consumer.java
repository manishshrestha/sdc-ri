...
public class Consumer extends AbstractIdleService {
    ...
    class ConnectorThread implements Runnable {
        ...
        private void connect() throws InterceptorException {
            ...
            // TODO: why mds is empty...? Shouldn't provider read mdib.xml on startup?

            //TODO: request mdib, check if texts contains REF if it does, invoke Localization Service to get
            // translation, maybe use cache too.
        }
    }
